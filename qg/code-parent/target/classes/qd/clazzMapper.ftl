...
public interface ${table.className}Mapper {
	...
	public ${table.className} get${table.className}ById(@Param(value = "id") String id)throws Exception;
	...
	public Integer delete${table.className}ById(@Param(value = "id") String id)throws Exception;
