...
<mapper namespace="com.${package}.mapper.${table.className}Mapper">
    ...
    <select id="get${table.className}ById" resultType="com.${package}.pojo.${table.className}">
        select
    ...
    <select id="get${table.className}ListByMap" resultType="com.${package}.pojo.${table.className}" parameterType="java.util.Map">
        select
        <#list table.cloumns as cloumn>
            <#if cloumn_has_next>
                ${cloumn.cloumnName} as ${cloumn.fieldName},
    ...
    <insert id="insert${table.className}" parameterType="com.${package}.pojo.${table.className}">
    ...
    <update id="update${table.className}" parameterType="com.${package}.pojo.${table.className}">
